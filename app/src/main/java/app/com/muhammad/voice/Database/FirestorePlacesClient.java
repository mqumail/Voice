...
import com.google.type.TimeZoneOrBuilder;
        //Duplicate class com.google.type.TimeZone$Builder found in modules jetified-proto-google-common-protos-2.7.2 (com.google.api.grpc:proto-google-common-protos:2.7.2) and jetified-protolite-well-known-types-18.0.0-runtime (com.google.firebase:protolite-well-known-types:18.0.0)

/** A proto wrapper for Firestore's client, that uses protos' binary format. */
public class FirestorePlacesClient {
...
//    }
//
//    public FirestorePlacesClient(String project, String token) {
